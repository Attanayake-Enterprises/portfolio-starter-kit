      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <Link href="/" className="flex min-w-0 items-center gap-3 self-start">
          ...
          <div className="min-w-0 leading-tight">
            ...
            <p className="mt-1 text-[10px] uppercase tracking-[0.16em] text-white/60 sm:text-[11px] sm:tracking-[0.24em]">
              precision metal solutions
            </p>
          </div>
        </Link>

        <nav className="grid w-full grid-cols-3 gap-2 sm:w-auto sm:flex sm:flex-wrap sm:justify-end" id="nav" aria-label="Primary navigation">
